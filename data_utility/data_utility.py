...
class CREAM_Day():
    ...
    To load information whether a specifc day is a working day (German working day in the dataset), use the get_weekday_
    information method.
    ...
    In the following, the object usage flow is described as it is intended:
    ...
    The object population is separated from the initalization to allow to lightweight, fast usage of the CREAM_Day class,
    without loading all the metadata information from the dataset files.
